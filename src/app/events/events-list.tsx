        ...
        <motion.div layout className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {events.map((event) => (
            ...
            >
              ...
              <div className="p-5">
                <h3 className="text-lg font-bold text-foreground group-hover:text-emerald-600 dark:group-hover:text-emerald-300">
                  {event.title}
                </h3>
                ...
                <Link href={`/events/${event.slug}`} className="mt-4 inline-block text-sm font-semibold text-emerald-600 hover:text-emerald-500 dark:text-emerald-300 dark:hover:text-emerald-200">
                  Lihat detail →
                </Link>
              </div>
            </motion.div>
